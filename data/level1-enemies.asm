init_level_enemies:
  ...
  add_init_enemy(ENEMY_MOUSE_TYPE, ENEMY_MOUSE_WIDTH, ENEMY_MOUSE_HEIGHT, 1, 7, 0, 10, 0)
  // add_init_enemy(ENEMY_MOUSE_TYPE, ENEMY_MOUSE_WIDTH, ENEMY_MOUSE_HEIGHT, 11, 15, 0, 6, 8)
  add_init_enemy(ENEMY_MOUSE_TYPE, ENEMY_MOUSE_WIDTH, ENEMY_MOUSE_HEIGHT, 17, 20, 0, 10, 0)
