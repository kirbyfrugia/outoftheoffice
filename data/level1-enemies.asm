init_level_enemies:
  ...
  add_init_enemy(ENEMY_MOUSE_TYPE, ENEMY_MOUSE_WIDTH, ENEMY_MOUSE_HEIGHT, 11, 25, 0, 10, 0)
  add_init_enemy(ENEMY_MOUSE_TYPE, ENEMY_MOUSE_WIDTH, ENEMY_MOUSE_HEIGHT, 28, 41, 0, 10, 0)
  add_init_enemy(ENEMY_MOUSE_TYPE, ENEMY_MOUSE_WIDTH, ENEMY_MOUSE_HEIGHT, 44, 51, 0, 10, 0)
